...
- All these metrics use an LLM alongside designated prompts to extract statements/claims from the element you want to evaluate in your LLM application.
- And then they assert whether the extracted information (Statement/claim) is aligned with or can be inferred from the ground truth corpus.
...
This project is currently maintained by Nikunj Shah, a Software Developer with expertise in Python, Java, and AI technologies. For questions or contributions, please contact nikunjshah0310@gmail.com.
